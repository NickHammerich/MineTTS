...
public class ProcedureSamdisappear extends ElementsMinettsMod.ModElement {
	public ProcedureSamdisappear(ElementsMinettsMod instance) {
		super(instance, 25);
	}

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			System.err.println("Failed to load dependency entity for procedure Samdisappear!");
			return;
		}
